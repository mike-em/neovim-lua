...
_G.packer_plugins = {
  ...
  ["DAPInstall.nvim"] = {
    loaded = true,
    path = "/Users/mike/.local/share/nvim/site/pack/packer/start/DAPInstall.nvim",
  ...
  ["crates.nvim"] = {
    loaded = true,
    path = "/Users/mike/.local/share/nvim/site/pack/packer/start/crates.nvim",
  ...
  ["lua-dev.nvim"] = {
    loaded = true,
    path = "/Users/mike/.local/share/nvim/site/pack/packer/start/lua-dev.nvim",
  ...
  ["nvim-ts-rainbow"] = {
    loaded = true,
    path = "/Users/mike/.local/share/nvim/site/pack/packer/start/nvim-ts-rainbow",
  ...
  ["rust-tools.nvim"] = {
    loaded = true,
    path = "/Users/mike/.local/share/nvim/site/pack/packer/start/rust-tools.nvim",
